    ...
    <>
        ...
        >
            <SimpleGrid spacing={12}>
                ...
                <Button leftIcon={<FaInstagram></FaInstagram>} href="http://instagram.com/magikmatriarch" component='a' variant="gradient" gradient={{ from: '#8a3ab9', to: '#e95950', deg: 35 }} size='lg' target="_blank">
                    Instagram
                </Button>

                <Button leftIcon={<FaTwitter></FaTwitter>} href="https://x.com/magikmatriarch?s=09" component='a' variant="gradient" gradient={{ from: '#1DA1F2', to: '#015d7c', deg: 35 }} size='lg' target="_blank">
                    Twitter
                </Button>
                ...
                <Button leftIcon={<SiOnlyfans/>} href="https://onlyfans.com/magikmatriarch" component='a' variant="gradient" gradient={{ from: '#8188F0', to: '#2281B3', deg: 35 }} size='lg' target="_blank">
                    OnlyFans
                </Button>

                <Button leftIcon={<BsCashCoin/>} href="https://cash.app/$magikmatriarch" component='a' variant="gradient" gradient={{ from: 'green', to: '#00D632', deg: 35 }} size='lg' target="_blank">
                    Full Attention
                </Button>
